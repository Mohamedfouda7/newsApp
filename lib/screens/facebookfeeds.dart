...
class fbfeeds extends StatefulWidget {
  @override
  _fbfeedsState createState() => _fbfeedsState();
}

class _fbfeedsState extends State<fbfeeds> {
          ...
          new Row(
            children: <Widget>[
              new IconButton(
                  icon: Icon(
                    Icons.favorite,
                    color: (favids.contains(index))?Colors.red: Colors.grey,
                  ),
                  onPressed: ( ) {
                    if(favids.contains(index)){
                      setState(() {
